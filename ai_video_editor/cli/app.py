...
def eval_section_editor(
    ...
    require_full_false_start_kept_index: bool = typer.Option(
        False,
        "--require-full-false-start-kept-index",
        help="Require whole-sentence false starts to identify a valid later take.",
    ),
) -> None:
